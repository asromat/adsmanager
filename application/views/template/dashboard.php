...
<body>
    ...
    <div class="appBottomMenu">
        ...
        <a href="<?= base_url("statistik/exportwartawan")?>" class="item <?=$this->uri->segment(2) == 'pencarian' ? "active" : ""?>">
            <div class="col">
                <ion-icon name="stats-chart-outline"></ion-icon>
                <strong>Statistik</strong>
            </div>
        </a>
        <a href="<?= base_url("iklan/tambahIklan")?>" class="item <?=$this->uri->segment(1) == 'iklan' ? "active" : ""?>">
            <div class="col">
                <ion-icon name="add-circle-outline"></ion-icon>
                <strong>Input</strong>
            </div>
        </a>
        <a href="<?= base_url("iklan/kontrak")?>" class="item <?=$this->uri->segment(1) == 'pertanyaan' ? "active" : ""?>">
            <div class="col">
